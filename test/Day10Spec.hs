  ...
  describe "cathode-ray Tube" $ do
    ...
    it "should execute some cpu instructions" $ do
      execute [ADDX 15, ADDX (-11), ADDX 6, ADDX (-3), ADDX 5, ADDX (-1), ADDX (-8)]
        `shouldBe` [Register 1 (1, 1), Register 2 (1, 16), Register 3 (16, 16), Register 4 (16, 5), Register 5 (5, 5), Register 6 (5, 11), Register 7 (11, 11), Register 8 (11, 8), Register 9 (8, 8), Register 10 (8, 13), Register 11 (13, 13), Register 12 (13, 12), Register 13 (12, 12), Register 14 (12, 4)]

    it "should find the signal strength during the 20th, 60th, 100th, 140th, 180th, and 220th cycles" $ do
      signals [Register 1 (1, 1), Register 2 (1, 16), Register 20 (16, 16), Register 4 (16, 5), Register 60 (5, 5), Register 6 (5, 11), Register 100 (11, 11), Register 8 (11, 8), Register 140 (8, 8), Register 10 (8, 13), Register 180 (13, 13), Register 12 (13, 12), Register 13 (12, 12), Register 220 (12, 4)]
        `shouldBe` [Register 20 (16, 16), Register 60 (5, 5), Register 100 (11, 11), Register 140 (8, 8), Register 180 (13, 13), Register 220 (12, 4)]
